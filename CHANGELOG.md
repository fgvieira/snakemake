...
## [8.4.1](https://github.com/fgvieira/snakemake/compare/v8.20.5...v8.4.1) (2024-10-03)


### ⚠ BREAKING CHANGES

* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/fgvieira/snakemake/issues/2403))
...
* add ability to inject conda environments into running Snakefile ([#2479](https://github.com/fgvieira/snakemake/issues/2479)) ([6140e29](https://github.com/fgvieira/snakemake/commit/6140e29864cf0fcdd83194f218408867c54b730d))
...
* add functionality for deploying sources if no shared FS is assumed ([#2486](https://github.com/fgvieira/snakemake/issues/2486)) ([76eac3c](https://github.com/fgvieira/snakemake/commit/76eac3c570624f818ff43f4759a27a3e284bf03c))
...
* allow to set latency_wait in executor test suite ([c0bca0b](https://github.com/fgvieira/snakemake/commit/c0bca0bb8bf66fb34def7459f757140ce3825a25))
...
* implement precommand ([#2482](https://github.com/fgvieira/snakemake/issues/2482)) ([ff0f979](https://github.com/fgvieira/snakemake/commit/ff0f979b68b1e12be8151c7f5547c6a13ad3ee9a))
...
* prepare for storage plugins ([#2454](https://github.com/fgvieira/snakemake/issues/2454)) ([353a71c](https://github.com/fgvieira/snakemake/commit/353a71cba1d3dfcc48136b2d6cb744cc1252623b))
...
* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/fgvieira/snakemake/issues/2403)) ([2be3bfa](https://github.com/fgvieira/snakemake/commit/2be3bfa4841967928069a2a024554b8a86b699f1))
...
* adapt to changes in snakemake-interface-executor-plugins ([635c68a](https://github.com/fgvieira/snakemake/commit/635c68abe3c6e01a70803f2423718a99ea056a00))
...
* also inherit rule proxies if there is no rulename modifier specified in a use rule statement ([#2440](https://github.com/fgvieira/snakemake/issues/2440)) ([1570289](https://github.com/fgvieira/snakemake/commit/15702891b31635a79f31e857d09f3e285f71717b))
...
* comparison to float in scheduler ([ef44d84](https://github.com/fgvieira/snakemake/commit/ef44d844b81d671604a1ce285a43ca1d5ea59d96))
...
* ensure that targetjob is always forced. This fixes a bug causing run-directive rules to not being executed even when enforced via e.g. -R. ([#2448](https://github.com/fgvieira/snakemake/issues/2448)) ([b2a60d5](https://github.com/fgvieira/snakemake/commit/b2a60d5674c84f58c6e48af5d675ce4690a1d625))
...
* handling of group jobs when obtaining temp input files ([71be1de](https://github.com/fgvieira/snakemake/commit/71be1de734032ae8c9e8b07fad57e36b321be421))
...
* Restore backward compatibility for Google Life Sciences executor ([#2461](https://github.com/fgvieira/snakemake/issues/2461)) ([5e3a464](https://github.com/fgvieira/snakemake/commit/5e3a46476d78d5d52340a9ffa327d18a5e7e9828))
...
* show failed logs in executor testcases ([92f7bf4](https://github.com/fgvieira/snakemake/commit/92f7bf4b86f491073898b2385c3ed45a557a3b4d))
...
* sort report (sub-)categories in lexicographical order ([#2449](https://github.com/fgvieira/snakemake/issues/2449)) ([d0705ad](https://github.com/fgvieira/snakemake/commit/d0705adb4702ead9db0c26809859c7b769d800e1))
...
* wait for logs before showing them on error ([a4ff328](https://github.com/fgvieira/snakemake/commit/a4ff3280db0beb4f1a077ee880433f767c4ad142))
...
* fix syntax in cluster example ([#2460](https://github.com/fgvieira/snakemake/issues/2460)) ([64e9645](https://github.com/fgvieira/snakemake/commit/64e964554748bdee93bad1c7e6cd2924595c414f))
...
* **rust:** Fix typo on rust-script version ([#2488](https://github.com/fgvieira/snakemake/issues/2488)) ([a79dd94](https://github.com/fgvieira/snakemake/commit/a79dd94f330f1d5c1fba7d16cb5b08bd780d950d))
